...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <!-- Registration Form -->
            <div id="registrationForm" class="form-container mb-4">
                ...
                <form action="signup.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" class="form-control" placeholder="Confirm Password" name="confpass"
                               required>
                        <?php if (isset($_SESSION['Password does not match'])): ?>
                            <div class="alert alert-danger mt-2" role="alert">
                                <?php echo $_SESSION['Password does not match']; ?>
                            </div>
                            <?php unset($_SESSION['Password does not match']); ?>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        <input type="email" class="form-control" placeholder="Email" name="email" required>
                        <?php if (isset($_SESSION['Email incorrect'])): ?>
                            <div class="alert alert-danger mt-2" role="alert">
                                <?php echo $_SESSION['Email incorrect']; ?>
                            </div>
                            <?php unset($_SESSION['Email incorrect']); ?>
                        <?php endif; ?>
                    </div>
